<article id="manual-install">
			...
			<ol>
				...
				<li>Open WordPress admin panel and go to "<b>Appearance -> Themes</b>".</li>
			...
			<ol>
				<li>Unpack the <strong>CherryFramework.zip</strong> archive and the <strong>theme####.zip</strong> archive on your local computer (right-click each .zip file, choose <strong>Unzip	toâ€¦ CherryFramework</strong> and <strong>theme####</strong>, after that you will see 2 folders: CherryFramework and theme####).		</li>
			...
			<ol>
				...
				<li>Open the <strong>theme####.sql</strong> file (located in the <strong>theme/manual_install/</strong> folder) using any code editor(Recommended software: Dreamweaver o Notepad) and change all lines with  "<strong>your_website_url_here</strong>" to your website URL via <strong>Find and Replace</strong>	(hot keys - Ctrl+H). E.g.: http://www.mywebsite.com</li>
