			...
			<div class="row">
				...
				<div class="grid_7">					
					<ul>
						...
						<li><i class="fa fa-angle-right"></i> <strong>style:</strong> - button color</li>
						<li><i class="fa fa-angle-right"></i> <strong>size:</strong> - button size</li>
						<li><i class="fa fa-angle-right"></i> <strong>display:</strong> - button display style</li>
